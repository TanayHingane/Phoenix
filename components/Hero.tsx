...
const Hero = () => {
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="bg-gradient-to-r from-pink-100 to-cyan-100 mt-20 gap-10 mb-4 rounded-2xl flex flex-col justify-center items-center h-[500px] max-w-[1000] max-h-[500px] lg:min-w-[1000px] xl:min-w-[1200px]">
        ...
        <div className="mt-3 mb-3 grid grid-cols-3 gap-7 mx-5 h-[120] hover:cursor-pointer">
          {/* 1stDiv */}
          <div className="bg-white w-[160] h-[190] rounded-xl">
            <NameCard />
          </div>
